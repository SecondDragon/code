...
var __decorate = (this && this.__decorate) || function (decorators, target,
  ...
  // 特殊说明：argsnum=4 装饰器修饰的是属性用package.json命令生成的是四个参数[第四个参数desc等于 void 0 [ndefined]]
  var targetinfo = argsnum < 3 ? target : desc === null ?
    desc = Object.getOwnPropertyDescriptor(target, key) : desc;//S100
