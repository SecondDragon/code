...
var OrderDetail = /** @class */function () {
    function OrderDetail(orderDetailId_, productname_, count_, price_) {
...
var orderDetail = new OrderDetail(12, "cc", 30, 2);
console.log(orderDetail.getTotal()); //NaN
console.log(_typeof(orderDetail.price)); //undefined
...
var Order2 = /** @class */function () {
    ...
    function Order2(orderId, date, custname, phone, orderDetailArray) {
...
var orderDetailOne = new OrderDetail_1.default(10, "电视机", 5000, 3);
var orderDetailTwo = new OrderDetail_1.default(11, "桌子", 2000, 2);
var orderDate = new Date(2023, 10, 17, 5, 20, 0);
var order = new Order2(1, orderDate, "李武", "33333", [orderDetailOne, orderDetailTwo]);
console.log(order);
},{"./OrderDetail":5}],4:[function(require,module,exports) {
...
//# sourceMappingURL=/Order2.dc4fe9f6.map