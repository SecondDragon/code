...
const componentVNodeHooks = {
  init (vnode: VNodeWithData, hydrating: boolean): ?boolean {
    if ( 
      ...
      vnode.data.keepAlive // 有keepAlive
    ) {
...
export function createComponent ( // 创建组件虚拟节点
  ...
  if (isObject(Ctor)) { // 调用Vue.extend方法 获得组件的构造函数
  ...
  const vnode = new VNode( // 创建组件虚拟节点  componentOptions
